...
namespace Portkey.Contracts.RedPacket {
  ...
  internal sealed partial class RedPacketMaxCountOutput : pb::IMessage<RedPacketMaxCountOutput>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
  ...
  internal sealed partial class SetRedPacketMaxCountInput : pb::IMessage<SetRedPacketMaxCountInput>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
